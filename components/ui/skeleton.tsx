...
const Skeleton = React.forwardRef<HTMLDivElement, SkeletonProps>(
  ({className, variant, size, animation, width, height, lines = 1, responsive = false, ...props}, ref) => {
...
export const AddressSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const TransactionHashSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const TokenAmountSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const BalanceSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const NetworkBadgeSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const WalletButtonSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'size' | 'variant'>>(
  ({className, ...props}, ref) => (
    <Skeleton
      ref={ref}
      variant="web3"
...
export const TransactionCardSkeleton = React.forwardRef<HTMLDivElement, Omit<SkeletonProps, 'variant' | 'lines'>>(
  ({className, ...props}, ref) => (
    <div
      ref={ref}
      className={cn(
